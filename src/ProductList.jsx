...
function ProductList() {
    ...
    const [showPlants, setShowPlants] = useState(true); // Set it to true to initially show plants
    ...
    const isProductInCart = (productName) => {
        return !!addedToCart[productName]; // Check if the product is in the addedToCart object
    };
    ...
    const handleAddToCart = (product) => {
        ...
        dispatch(addItem(product)); // Dispatch action to add the item to the cart
        setAddedToCart((prevState) => ({
            ...prevState,
            [product.name]: true // Mark the product as added
        }));
    }; // Closing brace for handleAddToCart
    ...
    return (
        <div>
            ...
            <div style={styleObjUl}>
                ...
                <span className="cart-count">{cartItemCount}</span> {/* Display item count */} </h1>
                    ...
                    <div className="product-list">
                        ...
                        <div className="product-card" key={plantIndex}>
                            ...
                            <button
                                            ...
                                            disabled={isProductInCart(plant.name)} // Disable if already added
                                        >
